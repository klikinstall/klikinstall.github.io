...
function timerLeft(){setInterval(function(){var e=document.getElementById("timer-v-days"),t=document.getElementById("timer-v-hours"),n=(document.getElementById("timer-v-hours__text"),document.getElementById("timer-v-minutes")),a=(document.getElementById("timer-v-minutes__text"),document.getElementById("timer-v-seconds")),o=(document.getElementById("timer-v-seconds__text"),(new Date).getTime()),i=new Date(2017,9,4,18),r=Math.floor((i-o)/1e3),s=r%3600,d=r%86400,l=Math.floor(r/86400),m=Math.floor(d/3600),c=Math.floor(s/60),u=Math.floor(s%60);e.innerHTML=l,t.innerHTML=m,n.innerHTML=c,a.innerHTML=u},1e3)}$(function(){$(window).on("load",function(){$("a[rel='m_PageScroll2id']").mPageScroll2id()});var e=$("#pull"),t=$("nav ul"),n=$("nav ul a");t.height();$(e).on("click",function(e){e.preventDefault(),t.slideToggle()}),$(n).on("click",function(e){$(window).width()<480&&t.slideToggle()}),$(window).resize(function(){$(window).width()>320&&t.is(":hidden")&&t.removeAttr("style")}),jQuery.fn.lightTabs=function(e){var t=function(){tabs=this,i=0,showPage=function(e){$(tabs).children("div").children("div").hide(),$(tabs).children("div").children("div").eq(e).show(),$(tabs).children("ul").children("li").removeClass("active"),$(tabs).children("ul").children("li").eq(e).addClass("active")},showPage(0),$(tabs).children("ul").children("li").each(function(e,t){$(t).attr("data-page",i),i++}),$(tabs).children("ul").children("li").click(function(){showPage(parseInt($(this).attr("data-page")))})};return this.each(t)},$("#photos_carousel").owlCarousel({loop:!0,margin:10,nav:!0,items:1,autoplay:!0,autoplayTimeout:15e3,smartSpeed:1e3,autoplaySpeed:1e3,responsive:{0:{nav:!1,dots:!1},480:{nav:!0,dots:!0}}}),$("#review_carousel").owlCarousel({loop:!0,margin:20,nav:!0,items:3,autoplay:!0,autoplayTimeout:15e3,smartSpeed:1e3,autoplaySpeed:1e3,responsive:{0:{items:1,nav:!1,dots:!0},768:{nav:!0,dots:!1}}})}),$(document).ready(function(){$(".program_tabs").lightTabs(),$("#photos_carousel").owlCarousel(),$("#review_carousel").owlCarousel(),$(".phone-mask").mask("+7 (999) 999-99-99"),$("#fscreen_call").submit(function(){return $.ajax({type:"POST",url:"mail.php",data:$(this).serialize()}).done(function(){$(this).find("input").val("");var e=$('#fscreen_call input[name="name"]').val(),t=$('#fscreen_call input[name="phone"]').val();$("#thanks").addClass("display_thanks"),$("#name_of").html(e),$("#phone_of").html(t),$("#thanks button").on("click",function(){$("#thanks").removeClass("display_thanks")}),$("#fscreen_call").trigger("reset")}),!1}),$("#callback").submit(function(){return $.ajax({type:"POST",url:"mail.php",data:$(this).serialize()}).done(function(){$(this).find("input").val(""),$("#openModal").css("display","none");var e=$('.modal input[name="name"]').val(),t=$('.modal input[name="phone"]').val();$("#thanks").addClass("display_thanks"),$("#name_of").html(e),$("#phone_of").html(t),$("#thanks button").on("click",function(){$("#thanks").removeClass("display_thanks")}),$("#callback").trigger("reset")}),!1});var e=$(window).width();e<=768&&$("#timer-v-days").length>0&&$("#timer-v-days").detach().appendTo(".program .count_days_mob"),e<=768&&$("#timer-v-hours").length>0&&$("#timer-v-hours").detach().appendTo(".program .count_hours_mob"),e<=768&&$("#timer-v-minutes").length>0&&$("#timer-v-minutes").detach().appendTo(".program .count_minutes_mob"),e<=768&&$("#timer-v-seconds").length>0&&$("#timer-v-seconds").detach().appendTo(".program .count_seconds_mob"),$(window).resize(function(){var e=$(window).width();e<=768&&$("#timer-v-days").length>0&&$("#timer-v-days").detach().appendTo(".program .count_days_mob"),e<=768&&$("#timer-v-hours").length>0&&$("#timer-v-hours").detach().appendTo(".program .count_hours_mob"),e<=768&&$("#timer-v-minutes").length>0&&$("#timer-v-minutes").detach().appendTo(".program .count_minutes_mob"),e<=768&&$("#timer-v-seconds").length>0&&$("#timer-v-seconds").detach().appendTo(".program .count_seconds_mob")}),$(window).resize(function(){var e=$(window).width();e>768&&$(".program #timer-v-days").length>0&&$("#timer-v-days").detach().appendTo(".s_recording .count_days"),e>768&&$(".program #timer-v-hours").length>0&&$("#timer-v-hours").detach().appendTo(".s_recording .count_hours"),e>768&&$(".program #timer-v-minutes").length>0&&$("#timer-v-minutes").detach().appendTo(".s_recording .count_minutes"),e>768&&$(".program #timer-v-seconds").length>0&&$("#timer-v-seconds").detach().appendTo(".s_recording .count_seconds")})}),timerLeft();