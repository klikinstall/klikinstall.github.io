...
$(function(){$(window).on("load",function(){$("a[rel='m_PageScroll2id']").mPageScroll2id()});var e=$("#pull"),a=$("nav ul"),t=$("nav ul a");a.height();$(e).on("click",function(e){e.preventDefault(),a.slideToggle()}),$(t).on("click",function(e){$(window).width()<480&&a.slideToggle()}),$(window).resize(function(){$(window).width()>320&&a.is(":hidden")&&a.removeAttr("style")}),jQuery.fn.lightTabs=function(e){var a=function(){tabs=this,i=0,showPage=function(e){$(tabs).children("div").children("div").hide(),$(tabs).children("div").children("div").eq(e).show(),$(tabs).children("ul").children("li").removeClass("active"),$(tabs).children("ul").children("li").eq(e).addClass("active")},showPage(0),$(tabs).children("ul").children("li").each(function(e,a){$(a).attr("data-page",i),i++}),$(tabs).children("ul").children("li").click(function(){showPage(parseInt($(this).attr("data-page")))})};return this.each(a)},$("#photos_carousel").owlCarousel({loop:!0,margin:10,nav:!0,items:1,autoplay:!0,autoplayTimeout:3e3,smartSpeed:1e3,autoplaySpeed:1e3,responsive:{0:{nav:!1,dots:!1},480:{nav:!0,dots:!0}}}),$("#review_carousel").owlCarousel({loop:!0,margin:20,nav:!0,items:3,autoplay:!0,autoplayTimeout:3e3,smartSpeed:1e3,autoplaySpeed:1e3,responsive:{0:{items:1,nav:!1,dots:!0},768:{nav:!0,dots:!1}}})}),$(document).ready(function(){$(".program_tabs").lightTabs(),$("#photos_carousel").owlCarousel(),$("#review_carousel").owlCarousel(),$(".phone-mask").mask("+7 (999) 999-99-99"),$("#callback").submit(function(){return $.ajax({type:"POST",url:"mail.php",data:$(this).serialize()}).done(function(){$(this).find("input").val(""),alert("Спасибо за заявку! Скоро мы с вами свяжемся."),$("#callback").trigger("reset")}),!1})});