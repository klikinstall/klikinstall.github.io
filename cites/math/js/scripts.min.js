...
$(function(){$(window).on("load",function(){$("a[rel='m_PageScroll2id']").mPageScroll2id()});var i=$("#pull"),n=$("nav ul");n.height();$(i).on("click",function(i){i.preventDefault(),n.slideToggle()}),$(window).resize(function(){$(window).width()>320&&n.is(":hidden")&&n.removeAttr("style")})});