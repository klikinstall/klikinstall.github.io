...
$(function(){$(window).on("load",function(){$("a[rel='m_PageScroll2id']").mPageScroll2id()});var n=$("#pull"),e=$("nav ul"),l=$("nav ul a");e.height();$(n).on("click",function(i){i.preventDefault(),e.slideToggle()}),$(l).on("click",function(i){$(window).width()<480&&e.slideToggle()}),$(window).resize(function(){$(window).width()>320&&e.is(":hidden")&&e.removeAttr("style")}),jQuery.fn.lightTabs=function(n){var e=function(){tabs=this,i=0,showPage=function(i){$(tabs).children("div").children("div").hide(),$(tabs).children("div").children("div").eq(i).show(),$(tabs).children("ul").children("li").removeClass("active"),$(tabs).children("ul").children("li").eq(i).addClass("active")},showPage(0),$(tabs).children("ul").children("li").each(function(n,e){$(e).attr("data-page",i),i++}),$(tabs).children("ul").children("li").click(function(){showPage(parseInt($(this).attr("data-page")))})};return this.each(e)}}),$(document).ready(function(){$(".program_tabs").lightTabs()});